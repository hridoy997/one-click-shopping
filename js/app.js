...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    <div class="single-product">
      ...
      <button id="details-btn" class="btn btn-info"><i class="fas fa-star"></i>${product.rating.rate}</button>
      <button id="details-btn" class="btn btn-secondary"><i class="fas fa-eye"></i>${product.rating.count}</button>
...
const updateTotal = () => {
  const grandTotal =
    ...
    const totalPrice = parseFloat(grandTotal);
